...
export const DumbbellSmallIcon = ({
    color,
    height = '24px',
    width = '24px',
    cursor = 'inherit',
    ...
    return (
        ...
        >
            ...
            <path
                d={
                    // eslint-disable-next-line max-len
                    'M5 10H4C2.89543 10 2 10.8954 2 12C2 13.1046 2.89543 14 4 14H5M9 12H15M19 14H20C21.1046 14 22 13.1046 22 12C22 10.8954 21.1046 10 20 10H19'
                }
                stroke={color === 'inherit' ? 'currentColor' : COLORS[color]}
                strokeWidth={'1.5'}
            />
